...
public class ShareManagerAS {
	...
	private ProjectManagerAS localProjMan = ProjectManagerAS
			.getManager(new ProjectDAOHashTableImp());
	private UserManagerAS userMan = UserManagerAS
	 ...
	 * 
	 * @param proj
	 *            The identifier of the project to share.
	 * @param authors
	 *            The list of authors.
	 * @param session
	 *            The session to validate this operation.
	 */
	 ...
	 *            The list of authors.
	 * @param users
	 *            The list of users which can view the project.
	 * @param session
	 *            The session to validate this operation.
	 */
