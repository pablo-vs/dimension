...
/**
 * Checks the functionality of the substract function.
 *
 * @author Inmaculada Pérez
 * @see SubstractFunction
 */
public class SubstractFunctionTest {

    /**
     * Test of toString method, of class SubstractFunction.
     */
    @Test
    ...
    /**
     * Test of evaluate method, of class SubstractFunction.
     */
    @Test
    public void testEvaluate() {
        ...
        assertEquals(Math.log10(6.0) - Math.log10(12.0),
                instanceSub.evaluate(new VariablesList(varValues, new String[]{"x"})), 0.0);
    }
