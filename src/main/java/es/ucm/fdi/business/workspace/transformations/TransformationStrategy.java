...
/**
 * Public abstract class representing a modification in a graph. Every
 * modification that could be applied to a graph implements this interface. The
 * interface allows the usage of the strategy pattern, each different
 * transformation is taken as a different approach (strategy) to the problem of
...
public abstract class TransformationStrategy {
    ...
    /**
     * Class constructor. It receives as parameters a numeric value showing how
     * the graph will change in each axis.
     *
     * @param x
     * @param y
     * @param z
