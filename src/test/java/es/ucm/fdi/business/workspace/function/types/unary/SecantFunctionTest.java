...
/**
 * Checks the functionality of the secant function.
 *
...
public class SecantFunctionTest {
    ...
    /**
     * Test of toString method, of class SecantFunction.
     */
    @Test
    public void testToString() {
        System.out.println("Testing 'toString' method...");
        VariablesList vars = new VariablesList(new String[]{"x"});
        SecantFunction instance = new SecantFunction(FunctionParserUtils
                .parse("PI/2", vars), vars);
        assertEquals("secan((3.141592653589793) / (2.0))", instance.toString());
    }

    /**
     * Test of evaluate method, of class SecantFunction.
     */
    @Test
